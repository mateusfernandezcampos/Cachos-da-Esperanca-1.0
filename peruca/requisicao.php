...
<html>
  <head>
    ...
    <meta charset="utf-8">
      <title> Requisição de peruca </title>
  ...
  <div class="container" id="navbarcima">
      ...
      <form class="row g-3" action="requisitar.php" method="post" enctype="multipart/form-data">
        <div class="row my-4">
          <div class="col-md-4">
            <label for="descricao" class="form-label">Descrição da peruca:</label>
            <textarea class="form-control descricao1" name="descricao"></textarea>
          </div>
        </div>
        <div class="row my-2">
          <div class="col-4">
        ...
        <input type="hidden" id="data" value="<?php echo $hoje;?>" name="data">
