...
<main>
    ...
    <div class="barzul"></div>    
      ...
      <ul class="nav nav-tabs nav-pills mx-5">
        ...
        <li class="nav-item">
          <a class="nav-link" href="perucas_usuario.php">Perucas</a>
        </li>
        <li class="nav-item">
      ...
      <div class="mx-5 my-2">
           ...
           <?php 
            if(isset($_GET["alterado"])) {  ?>
              <div class="alert alert-success" role="alert">
                ...
                $(".alert").delay(6000).slideUp(200, function() {
                    $(this).alert('close');
                    window.location.href = "doacoes_usuario.php";
                });
                </script>
            <?php } ?>
            ...
            <?php include_once "../conexao.php"; 
              ...
              $comandoSql = "select * from tb_doacao where cod_usuario='$idusu'";
              $resultado=mysqli_query($con,$comandoSql);
              while ($linha=mysqli_fetch_row($resultado)){
                //Comando para pegar o nome da ong via chave estrangeira da ong
                $comandoSqlNome = "select nome_ong from tb_ong where id_ong='$linha[1]'";
                ...
                <div class="list-group ">
                  <ul class="list-group list-group-flush ongls">
                    <li class="list-group-item"> 
                      <div class="row">
                        <div class="col">
                          <h4 class="my-2"> Doação realizada para <?php echo $nomeong["nome_ong"]; ?></h4>
                          <div class="row">
                            ...
                            <?php }else if($linha[5] == 1){ ?>
                              ...
                              <div class="modal fade" id="modalExcDoacao" role="dialog">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                  <div class="modal-content">
                                    <div class="modal-body mx-auto">
                                    ...
                                    <div class="modal-footer mx-auto">
                                      <form action="../doacao/excluir_doacao.php" method="post">
                                        <input type="hidden" name="iddoacao" value="<?=$linha[0]?>">
                              ...
                              <br> <br> <small class="text-muted"> <button type='button' class='btn btn-danger me-2 btn-sm' onclick='$("#modalExcDoacao").modal("toggle")'> X Excluir doação </button> </small>
                            <?php }else if($linha[5] == 0){ ?>
                              <small class="text-muted"> <b>Status:</b> <a class="text-black-50"> <b> Pendente </b> </a> </small>
                              <br> <small class="text-muted my-3"> <button type='button' class='btn btn-warning me-2 btn-sm' onclick="location.href='../doacao/altera_doacao.php?doacaoEscolhida=<?php echo $linha[0];?>'"> Alterar doação </button> </small>
                            <?php } ?> 
                          </div>
                        </div>
                      </div>
