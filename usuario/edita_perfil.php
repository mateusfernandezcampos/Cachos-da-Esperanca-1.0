...
<body>
  ...
  <main>
    ...
    <form action="altera_usuario.php" method="POST" class="needs-validation">
      <div class="row g-3 mx-5">

        <div class="col-md-4">
          <label for="inputEmail4" class="form-label">Nome:</label>
          <input type="text" class="form-control" id="nome" name="nome" value="<?= $_SESSION["usu_logado"]["nome_usuario"]; ?>" required autofocus>
        </div>
        <div class="col-md-1">
          <label for="inputAddress" class="form-label">RG:</label>
          <input type="text" class="form-control" id="rg" name="rg" value="<?= $_SESSION["usu_logado"]["rg_usuario"]; ?>" onfocus="$(this).mask('00.000.000-0');" required>
        </div>
        <div class="col-md-2">
          <label for="inputAddress" class="form-label">CPF:</label>
          <input type="text" class="form-control" id="cpf" name="cpf" value="<?= $_SESSION["usu_logado"]["cpf_usuario"]; ?>" onfocus="$(this).mask('000.000.000-00');" required>
        </div>
        <div class="col-1">
          <label for="inputCity" class="form-label">Cep:</label>
          <input type="text" class="form-control" id="cep" name="cep" value="<?= $_SESSION["usu_logado"]["cep_usuario"]; ?>" onfocus="$(this).mask('00000-000')" required>
        </div>
      </div>
      <div class="row g-3 mx-5 pt-2">
        <div class="col-md-3">
          <label for="inputAddress2" class="form-label">Email:</label>
          <input type="text" class="form-control" id="email" name="email" value="<?= $_SESSION["usu_logado"]["email_usuario"]; ?>" required>
        </div>
        <div class="col-md-2">
          <label for="inputAddress2" class="form-label">Telefone:</label>
          <input type="text" class="form-control" id="telefone" name="telefone" value="<?= $_SESSION["usu_logado"]["telefone_usuario"]; ?>" onfocus="$(this).mask('(00) 00000-0000')" required>
        </div>
        <div class="col-md-1">
