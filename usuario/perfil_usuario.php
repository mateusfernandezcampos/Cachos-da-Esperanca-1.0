...
<main>
    ...
    <div class="barzul"></div>    
      ...
      <div class="col-md-2">
        ...
        <p> <?php echo $_SESSION["usu_logado"]["nome_usuario"];?> </p>
      </div>
      <div class="col-md-1">
        <label for="inputAddress" class="form-label"><b>RG:</b></label>
        <p> <?php echo $_SESSION["usu_logado"]["rg_usuario"];?> </p>
      </div>
      <div class="col-md-2">
        <label for="inputAddress" class="form-label"><b>CPF:</b></label>
        <p> <?php echo $_SESSION["usu_logado"]["cpf_usuario"];?> </p> 
      </div>
      <div class="col-1">
        <label for="inputCity" class="form-label"><b>Cep:</b></label>
        <p> <?php echo $_SESSION["usu_logado"]["cep_usuario"];?> </p>
      </div>
      </div>      
      <div class="row g-3 mx-5 pt-2">
      <div class="col-md-2">
        <label for="inputAddress2" class="form-label"><b>Email:</b></label>
        <p> <?php echo $_SESSION["usu_logado"]["email_usuario"];?> </p>
      </div>
      <div class="col-md-2">
        <label for="inputAddress2" class="form-label"><b>Telefone:</b></label>
        <p> <?php echo $_SESSION["usu_logado"]["telefone_usuario"];?> </p>
      </div>
      <div class="col-md-1">
      ...
      <div class="my-2">
        <button class="btn btn-primary " onclick="location.href='edita_perfil.php'"> Editar perfil </button>
      </div>
