...
<main>
    ...
    <div class="barzul"></div>    
      ...
      <ul class="nav nav-tabs nav-pills mx-5">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Perucas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="perfil_avancado.php">Configurações avançadas</a>
        </li>
      </ul>     
      <br>
      ...
      <form action="altera_cadastro.php" method="POST" class="needs-validation">
      <div class="row g-3 mx-5">
        <div class="col-md-2">
          <label for="usuario" class="form-label">Usuário:</label>
          <input type="usuario" class="form-control" id="usuario" name="usuario" required autofocus>
        </div>
      </div>
      ...
      <div class="row g-3 mx-5 pt-5">
        <div class="col-md-4">
        <button class="btn btn-primary btn-lg" type="submit"> Alterar cadastro </button>
        </div>
      </div>
