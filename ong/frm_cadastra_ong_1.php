...
<head>
  ...
  <link href="../css/cadastro_ong.css" rel="stylesheet">
</head>
...
<div class="container">
    ...
    <div class="form_direita my-auto col">   
        <form action="frm_cadastra_ong_2.php" method="POST" class="needs-validation formulario mx-auto my-auto" novalidate>
          <h1 class="h1 mb-4 fw-normal cadastrar">Cadastro</h1>

          <div class="form-floating has-validation asa">
        ...
        <a href="../index.php" class="mb-3"> Início </a>
      </div>
  </div>  
  </main>
